 ...
 */
class AdCKEditor extends CInputWidget
{
	/**
	...
	public function run()
	{
		...
		if ($this->hasModel()) {
			if ($this->form) {
				...
				$html = TbHtml::activeTextArea($this->model, $this->attribute, $this->htmlOptions);
			}
		} else {
			$html = TbHtml::textArea($name, $this->value, $this->htmlOptions);
		}
		echo $html;
	}
	...
	{
		Yii::app()->andystrap->registerPackage('ckeditor');
